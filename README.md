...
- **[`automation/cursor_propose_only/README.md`](./automation/cursor_propose_only/README.md)** — optional proposal orchestration workflow (proposal selection, planning bundles, and automated execution/review loops).
...
| [`automation/cursor_propose_only/README.md`](./automation/cursor_propose_only/README.md) | Optional orchestration workflow for proposal selection, planning/review loops, and automated per-PR execution via command templates. |
