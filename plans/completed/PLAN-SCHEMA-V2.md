...
Status: **completed** — PR-A/B/C/D landed; PR-D in [`plans/completed/PLAN-HINTS-V3.md`](./PLAN-HINTS-V3.md). Implements
[`propose/completed/SCHEMA-V2-PROPOSE.md`](../../propose/completed/SCHEMA-V2-PROPOSE.md).

Depends on:

- [`propose/completed/HINTS-V3-PROPOSE.md`](../propose/completed/HINTS-V3-PROPOSE.md) **merged to `master`** before **PR-A** implementation starts (SCHEMA-V2 Decision 30; GitHub PR may stay `draft`).
- [`docs/PROPOSES-ORDER.md`](../docs/PROPOSES-ORDER.md) for lock/merge sequence across proposes and code PRs.
- **PR-D (hints v3)** is specified in [`plans/completed/PLAN-HINTS-V3.md`](./PLAN-HINTS-V3.md) — not repeated here beyond overview/tracking.
...
| PR-D | Hints v3 (empty `neighbors`) | **No** (query-time) | See [`plans/completed/PLAN-HINTS-V3.md`](./PLAN-HINTS-V3.md) | `test_mcp_hints.py` HV* | PR-A/B/C |
